...
const myStream = fs.createWriteStream('datafile.csv', 'utf8');
...
writeMillionsOfTimes(numOfRecords, () => {
  myStream.end()
  console.log(`done with writing ${numOfRecords} records`)
});
