  ...
  function write() {
    ...
    while (i > 0 && ok) {
      ...
      var oneHotel = {
        ...
        hotel_website: `google.com` //faker.internet.url()
      }
      ...
      for (var j = 0; j < 8; j++) {
        ...
        oneHotel.images.push(` sdcabout.s3.us-west-1.amazonaws.com/image${randomPhoto}.jpg`)
      }
