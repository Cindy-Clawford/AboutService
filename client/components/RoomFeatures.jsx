  ...
  return (
    <FeaturesContainer>
      ...
      <div>
        ...
        {featuresToShow.map((feature, index) => <div key={index} style={{padding: "0 0 10px"}}><img src={featuresIcons[feature]} height="15px" width="15px" style={{verticalAlign: "middle"}}></img><span>  {feature}</span></div>)}
      </div>
      {features.length > 6 ? <ShowMoreFeatures>Show more</ShowMoreFeatures> : <div></div>}
      </div>
    </FeaturesContainer>
  )
}
